...
object MusicClassifier {
	...
	fun classify(
		...
		if (autoGenerated) return song("auto-generated Art Track (distributor feed)")
		if (isTopicChannel(ch)) return song("YouTube Topic channel (distributor feed)")
		...
		// 3. A confirmed recording in MusicBrainz. Hard evidence: it names a
