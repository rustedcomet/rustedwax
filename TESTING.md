# Testing RustedWax v0.5.2

`dist/rustedwax-0.5.2.apk` — detection, key handling, automatic scrobbling
...
```bash
~/Library/Android/sdk/platform-tools/adb install -r dist/rustedwax-0.5.2.apk
```
...
87 tests: 17 crypto/serialization vectors generated by dhive (the library
...
title-parsing, 10 threshold/double-listen, 8 notification-hint binding, 6
watch-page extraction, 6 MusicBrainz matching.

## Known gaps in v0.5.2
