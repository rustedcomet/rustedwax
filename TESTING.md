# Testing RustedWax v0.6.0

`dist/rustedwax-0.6.0.apk` — detection, key handling, automatic scrobbling
...
```bash
~/Library/Android/sdk/platform-tools/adb install -r dist/rustedwax-0.6.0.apk
```
...
111 tests: 17 crypto/serialization vectors generated by dhive (the library
...
address-bar corroboration, 10 search-based id resolution, 7 dedup-key, 6
watch-page extraction, 6 MusicBrainz
matching.

## Known gaps in v0.6.0
