# Testing RustedWax v0.7.0

`dist/rustedwax-0.7.0.apk` — detection, key handling, automatic scrobbling
...
```bash
~/Library/Android/sdk/platform-tools/adb install -r dist/rustedwax-0.7.0.apk
```
...
124 tests: 17 crypto/serialization vectors generated by dhive (the library
